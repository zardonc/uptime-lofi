...
4. Leave `pages_url` empty/default unless you already know your deployed Pages URL should be different. If omitted, the workflow uses `https://{resource_prefix}.{account}.pages.dev`, for example `https://uptime-lofi.lmyyah.pages.dev`.
